...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={'padding-left':3, 'font_size':20,'align-items':'center'}
        )
    ]),
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,
                x='Vehicle_Type',
                y='Automobile_Sales',
                title="Average Automobile Sales by Vehicle_Type"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        bar_data = recession_data.groupby(['unemployment_rate','Vehicle_Type'], as_index=False)['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(
                        ...
                        x='Year',
                        y='Automobile_Sales',
                        title="Average Automobile Sales fluctuation over Period"
                        )
                        )
            
# Plot 2 Total Monthly Automobile sales using line chart.
        monthly_sales = data.groupby(['Year', 'Month'], as_index=False)['Automobile_Sales'].sum()
        Y_chart2 = dcc.Graph(
                        figure=px.line(
                        monthly_sales,
                        x='Month', 
                        y='Automobile_Sales', 
                        color='Year',
                        title="Average Automobile Sales fluctuation over Period by Month"
                        )
                        )
